package com.jspforms.jakubborkowski.security.jwt;
import io.jsonwebtoken.*;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.security.core.Authentication;
import org.springframework.stereotype.Component;
import com.jspforms.jakubborkowski.security.services.UserPrinciple;
...
public class JwtProvider {
    ...
    @Value("${com.jspforms.jakubborkowski.jwtSecret}")
    private String jwtSecret;

    @Value("${com.jspforms.jakubborkowski.jwtExpiration}")
